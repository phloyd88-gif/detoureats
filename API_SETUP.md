...
If review-backed Google results already worked in v1.9.7, the same key should work in v2.0.6. Redeploying the repository is sufficient.

### Usage monitoring

Because v2.0.6 adds Google-powered route discovery, it can make more Places requests than earlier releases. During beta testing:
...
Confirm the footer reads `DetourEats v2.0.6`, then use a private window or remove and reinstall the home-screen app.
