const CACHE_NAME = "detoureats-v2-0-2-eligibility-rescue";
...
const ASSETS = [
  ...
  "./data.js?v=2.0.2",
  "./engine.js?v=2.0.2",
  "./review-evidence.js?v=2.0.2",
  "./place-status.js?v=2.0.2",
  "./live-route.js?v=2.0.2",
  "./address-search.js?v=2.0.2",
  "./restaurant-intelligence.js?v=2.0.2",
  "./app.js?v=2.0.2",
