...
9. Confirm the footer reads `DetourEats v2.0.2`.
...
Version 2.0.2 uses new JavaScript/CSS query strings and a new service-worker cache. It also migrates the former hard chain default to independent-first fallback behavior. A private window is still recommended for the first test. If an installed home-screen app remains stale, remove it and install it again.
