/* DetourEats v2.0.4 review-backed evidence API */
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return end(res, 200, { version: "2.0.4", status: "ok", configuredProviders: configured, results });
  } catch (error) {
...
async function redditEvidence(candidate) {
  ...
  const headers = {
    ...
    "User-Agent": process.env.REDDIT_USER_AGENT || "web:detoureats:v2.0.4 (restaurant evidence)"
  };
